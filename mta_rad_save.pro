...
config_files = strarr(17)
;config_files(0) = '/data/mta/Script/OBT/MJ/Save/comprehensive_data_summary1999'
;config_files(1) = '/data/mta/Script/OBT/MJ/Save/comprehensive_data_summary2000'
;config_files(2) = '/data/mta/Script/OBT/MJ/Save/comprehensive_data_summary2001'
;config_files(3) = '/data/mta/Script/OBT/MJ/Save/comprehensive_data_summary2002'
;config_files(4) = '/data/mta/Script/OBT/MJ/Save/comprehensive_data_summary2003'
;;config_files(5) = '/data/mta_www/mta_temp/mta_states/MJ/2004/comprehensive_data_summary2004'
;config_files(5) = '/data/mta/Script/OBT/MJ/mta_comprehensive_data_summary'
config_files(0) = '/data/mta_www/mta_temp/mta_states/MJ/1999/comprehensive_data_summary1999'
config_files(1) = '/data/mta_www/mta_temp/mta_states/MJ/2000/comprehensive_data_summary2000'
config_files(2) = '/data/mta_www/mta_temp/mta_states/MJ/2001/comprehensive_data_summary2001'
config_files(3) = '/data/mta_www/mta_temp/mta_states/MJ/2002/comprehensive_data_summary2002'
config_files(4) = '/data/mta_www/mta_temp/mta_states/MJ/2003/comprehensive_data_summary2003'
config_files(5) = '/data/mta_www/mta_temp/mta_states/MJ/2004/comprehensive_data_summary2004'
config_files(6) = '/data/mta_www/mta_temp/mta_states/MJ/2005/comprehensive_data_summary2005'
config_files(7) = '/data/mta_www/mta_temp/mta_states/MJ/2006/comprehensive_data_summary2006'
config_files(8) = '/data/mta_www/mta_temp/mta_states/MJ/2007/comprehensive_data_summary2007'
config_files(9) = '/data/mta_www/mta_temp/mta_states/MJ/2008/comprehensive_data_summary2008'
config_files(10) = '/data/mta_www/mta_temp/mta_states/MJ/2009/comprehensive_data_summary2009'
config_files(11) = '/data/mta_www/mta_temp/mta_states/MJ/2010/comprehensive_data_summary2010'
config_files(12) = '/data/mta_www/mta_temp/mta_states/MJ/2011/comprehensive_data_summary2011'
config_files(13) = '/data/mta_www/mta_temp/mta_states/MJ/2012/comprehensive_data_summary2012'
config_files(14) = '/data/mta_www/mta_temp/mta_states/MJ/2013/comprehensive_data_summary2013'
config_files(15) = '/data/mta_www/mta_temp/mta_states/MJ/2014/comprehensive_data_summary2014'
config_files(16) = '/data/mta_www/mta_temp/mta_states/MJ/2015/comprehensive_data_summary2015'
...
;ephemfile = '/home/mta/PASS/dephem.dat'
...
orange = 215 
;orange = 20  
;red = 140 ; if colors go nuts, try these
;yellow = 112 
;blue = 60 
;green = 80  
;purple = 40  
...
if (n_elements(goes_p1) gt 2) then begin
  ...
  no_data = 1
endelse
if (ymax - ymin gt 100) then setlog = 'yes'
if (ymax - ymin le 100) then setlog = 'no'
...
;if (xmin gt 166201263) then $
;xyouts, xmax+((xmax-xmin)*0.025), ymax, 'GOES10 RATES', alignment=1.0, $
;        orientation = 90, charsize=1.1
;if (xmax lt 166201263) then $
;xyouts, xmax+((xmax-xmin)*0.025), ymax, 'GOES8 RATES', alignment=1.0, $
;        orientation = 90, charsize=1.5
;if (xmax gt 166201263 and xmin lt 166201263) then $
;xyouts, xmax+((xmax-xmin)*0.025), ymax, 'GOES8/10 RATES', alignment=1.0, $
;        orientation = 90, charsize=0.8
;xyouts, 0.5, 0.9, 'COMING SOON ....', alignment= 0.5, $
;        color = white, charsize=1.2, /normal   ;temporary
...
;tmp2 = min(p_4gm(where(p_4gm gt 0)))
;tmp3 = min(p41gm(where(p41gm gt 0)))
;tmp4 = min(p41gm(where(p41gm gt 0)))
...
;oplot, time, p41gm, color = blue
;xyouts, 1.0, 0.34, 'SCP4', alignment = 1.0, color = yellow, /normal
;oplot, time, p41gm, color = blue
;xyouts, 1.0, 0.32, 'SCP41', alignment = 1.0, color = blue, /normal
;
; sca00 is not updated anymore
;
;;;oplot, ephscatime, ephsca00, color = green
;;;xyouts, 1.0, 0.30, 'SCA00', alignment = 1.0, color = green, /normal

; plot operation limits
oplot, [xmin,xmax], [e1300_lim, e1300_lim], color = red
oplot, [xmin,xmax], [e150_lim, e150_lim], color = yellow
;oplot, [xmin,xmax], [p_4gm_lim, p_4gm_lim], color = yellow
;oplot, [xmin,xmax], [p41gm_lim, p41gm_lim], color = blue
...
;xyouts, 1.0, 0.0, systime(), alignment = 1, color = white, /normal
;write_png, 'rad_cnts.png', reverse(rotate(tvrd(/true),2))
...
b = intarr(1)
b(0) = needed
;while (endpars gt start_year and needed lt n_elements(config_files)-2) do begin
...
plot, time, replicate(0, n_elements(time)), psym = 3, $
        yticks = 1, yticklen = 0, $
        ;xtitle = 'time (DOM)', ytitle = '', title = 'Usable time intervals', $
  ...
  for i = 1, n_elements(hetg_start)-1 do begin
    ;print, "data ",cxtime(hetg_start(i))," ", cxtime(hetg_end(i)) ;debug
    ;print, "randge ", xmin, " ", xmax ;debug
    tstart = max([hetg_start(i), xmin])
    tend   = min([hetg_end(i), xmax])
    ;print, "plot ",tstart," ",tend ;debug
...
;t_min = 1500   ; minimum time in rad zone, to avoid false detections
...
for i = 0L, num - 1 do begin
  ...
  if ((tend - tstart lt t_max) and (tend-tstart gt t_min)) then begin
    ...
    j = j + 1
    ;print, "Rad ", j, " ", tstart, " ", tend ;debug
  endif
endfor
j=1
if (j gt 0) then begin
  ;;defuctrad_start = rad_start[1:*] ; delete first dummy element
  ;;defuctrad_end = rad_end[1:*] ; delete first dummy element
  ...
  ; plot rad
  ;;defuctget_lun, tmpunit
  ;;defuctopenw, tmpunit, 'xradstart.tmp'
  ;;defuctfor i = 0, n_elements(rad_start)-1 do begin
    ;;defuctprintf, tmpunit, rad_start(i), " ", rad_end(i)
    ;;defucttstart = rad_start(i)
    ;;defucttend   = rad_end(i)
    ;;defuctpolyfill, [tstart, tstart, tend, tend], [ymin, ymax, ymax, ymin], $
                      ;;defuctcolor = red, /data
  ;;defuctendfor
  ;;defuctclose, tmpunit
  ;xyouts, 1.0, 0.61, 'RAD', alignment = 1.0, $
  ;                  color = red, /normal
  ...
  if (cnt gt 0) then begin
    ...
    mag_z=mag_z(b)
    crm_reg=crm_reg(b)
  endif ;if (cnt gt 0) then begin
  ;alt_r=sqrt(alt_x^2+alt_y^2+alt_z^2)/1000.0
  ;alt_s=((alt_r-min(alt_r))*(ymax-ymin)/(max(alt_r)-min(alt_r))) + ymin ; rescale
  ...
  while (r lt cnt-2) do begin
    ...
    endcase
  endwhile ; while (r lt cnt-2) do begin
...
for i = 0L, num - 1 do begin
  ...
  endwhile
  if (rad_in eq 1) then begin
    tend = ephsca(i-1).time ; we've been in the rad zone, what time did we exit
  endif              ; rad_in is reset at top of loop
  if ((tend - tstart lt t_max) and (tend-tstart gt t_min)) then begin
...
plot, time, replicate(0, n_elements(time)), psym = 3, $
  ...
  label_year, xmin, xmax, ycon(1), csize=1.2
  ;write_png, 'rad_use.png', reverse(rotate(tvrd(/true),2))
...
ycon = convert_coord([0],[0], /device, /to_data)
label_year, xmin, xmax, ycon(1), csize=1.2
;write_png, 'time_diff.png', reverse(rotate(tvrd(/true),2))
...
b = where(orbit_diff lt 90.0*3600.0 and orbit_diff gt 0)
yplot=orbit_diff(b)/3600.0
ymin=min(yplot)
ymax=max(yplot)
ywide=ymax-ymin
...
b = where(entr_diff lt 15.0*3600.0 and entr_diff gt 0)
...
b = where(exit_diff lt 15.0*3600.0 and exit_diff gt 0)
...
;        ;max_value = mean(0)+(2*sqrt(mean(1))), $
;        ;min_value = mean(0)-(2*sqrt(mean(1))), $
;        title = 'Time between consecutive SCA00 sats', $
;        ystyle = 1, xstyle = 1, $
;        xrange = [xmin, xmax], xmargin = [12,2], $
;        yrange = [ymin, ymax], $
;        charsize = 1.8, charthick =1, color = white, background = bgrd, $
...
;        ;max_value = mean(0)+(2*sqrt(mean(1))), $
;        ;min_value = mean(0)-(2*sqrt(mean(1))), $
;        title = 'Time between consecutive SCA00 unsats', $
;        charsize = 1.8, charthick =1, color = white, background = bgrd, $
;        xticks=nticks-1, xtickv = doyticks, xminor=10, $
;        xtickformat='s2doy_axis_labels'
;endif
;
;;;b = where(rad_diff lt 30.0*3600.0 and rad_diff gt 0)
;;b = where(rad_diff gt 0)
;yplot=rad_diff(b)/3600.0
;ymin=min(yplot)
;ymax=max(yplot)
;ywide=ymax-ymin
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time in SCA00 sat', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels',/nodata
;
;b = where(orbit_diff lt 90.0*3600.0 and orbit_diff gt 0)
;;b = where(orbit_diff gt 0)
;yplot=orbit_diff(b)/3600.0
;ymin=min(yplot)
;ymax=max(yplot)
;ywide=ymax-ymin
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time out of SCA00 sat', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels'

;b = where(entr_diff lt 15.0*3600.0 and entr_diff gt 0)
;;b = where(entr_diff gt 0)
;yplot=entr_diff(b)/3600.0
;ymin=min(yplot)
;ymax=max(yplot)
;ywide=ymax-ymin
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time between RADMON disable and SCA00 sat', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels'

;b = where(exit_diff lt 15.0*3600.0 and exit_diff gt 0)
;;b = where(exit_diff gt 0)
;yplot=exit_diff(b)/3600.0
;ymin=min(yplot)
;ymax=max(yplot)
;ywide=ymax-ymin
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time between SCA00 unsat and RADMON enable', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels'
;
;b = where(abs(ephs_diff) lt 15.0*3600.0)
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time between SCA00 sat and RADZONE entry', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels'

;b = where(abs(ephe_diff) lt 15.0*3600.0)
...
;      ;max_value = mean(0)+(2*sqrt(mean(1))), $
;      ;min_value = mean(0)-(2*sqrt(mean(1))), $
;      title = 'Time between SCA00 unsat and RADZONE exit', $
;      charsize = 1.8, charthick =1, color = white, background = bgrd, $
;      xticks=nticks-1, xtickv = doyticks, xminor=10, $
;      xtickformat='s2doy_axis_labels'
;ycon = convert_coord([0],[0], /device, /to_data)
...
ycon = convert_coord([0],[0], /device, /to_data)
label_year, xmin, xmax, ycon(1), csize=1.2
;write_png, 'xper_diff.png', reverse(rotate(tvrd(/true),2))
